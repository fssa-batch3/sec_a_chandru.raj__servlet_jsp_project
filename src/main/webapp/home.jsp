  ...
  <body>
    ...
    <header>
      <nav>
        <div class="logo">
          <!-- <a href="..//index.html" -->
            ><img alt="image" src="./images/Redefine.png"
          /></a>
        </div>

        <ul>
          <li>
            <a id="addYours"  href="hall.html" >Add your's <div class="options">
              <div class="halls" onclick="sellerForm()">Halls</div>
              <div class="catteringService" >Catering Service</div>
              <div class="invitationCards" onclick="invitation()">Invitation Cards</div>
            </div> </a>
           </li>
          <li>
    ...
    <section>
      ...
      <div class="main">
        ...
        <div class="adiv">
          <a class="a" href="listHallsServlet">View More</a>
        </div>
      </div>
      <div class="main">
      ...
      <div class="main">
        ...
        <div class="adiv">
          <a class="a" href="../pages/admin-update.html">View More</a>
        </div>
      </div>
    </section>